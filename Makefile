...
/dev/shm/runCsv: src/runCsv.d src/libPdbToJson.d src/libJsonToXml.d src/libJsonToWav.d  src/waved/detect.d src/waved/package.d src/waved/utils.d src/waved/wav.d
	gdc -o$@ $^
...
all: /dev/shm/jsonToXml /dev/shm/jsonToWav /dev/shm/pdbToJson /dev/shm/runCsv json output scores wav
